...
import org.sonar.java.xml.XmlFileScannerContext;
...
@ActivatedByDefault
public class DefaultInterceptorsLocationCheck implements XmlFileScanner {

  @Override
  public void scanFile(XmlFileScannerContext context) {
    if (!"ejb-jar.xml".equalsIgnoreCase(context.getXmlFile().getName())) {
      try {
  ...
  private void reportOnClasses(XmlFileScannerContext context, Node interceptorBinding) throws XPathExpressionException {
